...
public class AuthenticationUI implements Runnable {
    ...
    private List<MenuItem> getMenuItemForRoles() {
        ...
        rolesUI.add(new MenuItem(AuthenticationController.ROLE_OWNER, new ClientUI()));
        rolesUI.add(new MenuItem(AuthenticationController.ROLE_MANAGER, new NetworkManagerUI()));
